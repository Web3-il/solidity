...
/**
 * @title web ERC20 token
 * @dev  
 *      The goal of web is to Go Up Higher in price over time.
 *      Based on the Ampleforth protocol.
 */
contract web is ERC20Detailed, Ownable {
    ...
    constructor()
        ERC20Detailed("wev3-il", "web", uint8(DECIMALS))
        public
    {
